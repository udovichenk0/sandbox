...
})({"hAXra":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "c9cec33b739a5a8b";
"use strict";
...
function disabledActionDestinations(plan, settings) {
    ...
    ((_a = settings.remotePlugins) !== null && _a !== void 0 ? _a : []).forEach(function(p) {
        disabledIntegrations.forEach(function(int) {
            if (p.creationName == int) disabledRemotePlugins.push(p.name);
        });
    });
    return ((_b = settings.remotePlugins) !== null && _b !== void 0 ? _b : []).reduce(function(acc, p) {
        if (p.settings["subscriptions"]) {
            if (disabledRemotePlugins.includes(p.name)) // @ts-expect-error element implicitly has an 'any' type because p.settings is a JSONObject
    ...
    function filter(ctx) {
        ...
        if (plan && ev) {
            ...
            if (!(0, _isPlanEventEnabled.isPlanEventEnabled)(plan, planEvent)) {
                ...
                ctx.updateEvent("integrations", (0, _tslib.__assign)((0, _tslib.__assign)((0, _tslib.__assign)({}, ctx.event.integrations), planEvent === null || planEvent === void 0 ? void 0 : planEvent.integrations), disabledActions));
            }
        }
        return ctx;
    }
...
},{"tslib":"lRdW5","../../lib/is-plan-event-enabled":"dVwrQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dVwrQ":[function(require,module,exports) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hAXra"], null, "parcelRequire5b12")

//# sourceMappingURL=schema-filter.739a5a8b.js.map
